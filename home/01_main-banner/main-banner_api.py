...
def main_banner():
    ...
    # API URLs
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/beauty/sections/520/main-banner'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/beauty/sections/520/main-banner'
    ...
    # HTML 리포트 생성
    report_path = comparator.generate_html_report('main-banner_api_report.html')
