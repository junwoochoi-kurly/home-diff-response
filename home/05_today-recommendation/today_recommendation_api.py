...
def main():
    ...
    # API URLs
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/market/sections/118/today-recommendation'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/market/sections/118/today-recommendation'
