...
def main():
    ...
    # API URLs (확인필요)
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/market/sections/1562/collections/hmqs70st/products'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/market/sections/1562/collections/hmqs70st/products'
