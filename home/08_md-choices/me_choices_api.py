...
def main():
    ...
    # API URLs (확인필요)
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/market/sections/552/md-choices/991013/products'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/market/sections/552/md-choices/991013/products'
