...
def main():
    ...
    # API URLs
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/market/sections/501/group-collection-circle'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/market/sections/501/group-collection-circle'
