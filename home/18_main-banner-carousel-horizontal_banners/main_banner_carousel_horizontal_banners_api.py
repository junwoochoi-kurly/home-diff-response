...
def main():
    ...
    # API URLs
    old_url = f'{OLD_API_DOMAIN}/api/public/v3/sites/market/sections/537/main-banner-carousel-horizontal/banners'
    new_url = f'{NEW_API_DOMAIN}/public/v3/sites/market/sections/537/main-banner-carousel-horizontal/banners'
