...
def footer():
    ...
    # API URLs
    old_url = f'{OLD_API_DOMAIN}/api/public/v1/main/company-profile'
    new_url = f'{NEW_API_DOMAIN}/public/v1/main/company-profile'
    ...
    # HTML 리포트 생성
    report_path = comparator.generate_html_report('footer_api_report.html')
